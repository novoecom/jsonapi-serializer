...
module.exports = function (collectionName, records, opts) {
  this.serialize = function (records, sOpts = {}) {
    var that = this;
    var payload = {};
    ...
    if (that.opts.meta) {
      if (sOpts.meta && !isFunction(that.opts.meta)) {
        payload.meta = sOpts.meta;
      }

      else if (sOpts.meta && isFunction(that.opts.meta)) {
        payload.meta = that.opts.meta(sOpts.meta);
      }
